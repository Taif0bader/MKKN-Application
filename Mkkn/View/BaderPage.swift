                    ...
                    VStack{
                        VStack(alignment: .leading, spacing: 12){
                            ...
                            HStack{
                                ...
                                Text("Bachelor of Sociology")
                            }
                            HStack{
                                Text("Experience:")
                                    .foregroundColor(Color("ButtonsColor"))
                                
                                Text("Seller for a year")
                            }
                            
                            Text("Skills:")
                                .foregroundColor(Color("ButtonsColor"))
                            
                            Text("Analysis, Time management, Leadershipsis")
...
struct BaderPage_Previews: PreviewProvider {
